...
//             <strong>닉네임:</strong> {userInfo.nickname}<br/>
...
//                 }}
//               >
//                 <img src="https://img.icons8.com/color/24/000000/google-logo.png" alt="구글 로고" style={{ width: 24, height: 24 }} />
//                 구글 본인 인증
//               </button>
//               {/* 네이버 본인 인증 버튼 */}
//               <button
...
//                 style={{
//                   display: 'flex', alignItems: 'center', gap: 10, justifyContent: 'center',
//                   background: '#03C75A', color: '#fff', border: 'none', borderRadius: 8,
//                   padding: '12px 0', fontWeight: 600, fontSize: 16, cursor: 'pointer', width: '100%',
//                   marginBottom: 0, height: 48,
//                   boxShadow: socialType === 'naver' ? '0 0 0 2px #03C75A' : 'none'
//                 }}
//               >
//                 <span style={{ fontWeight: 900, fontSize: 20, fontFamily: 'Arial' }}>N</span>
//                 네이버 본인 인증
//               </button>
//               {/* 카카오 본인 인증 버튼 */}
//               <button
...
//                 style={{
//                   display: 'flex', alignItems: 'center', gap: 10, justifyContent: 'center',
//                   background: '#FEE500', color: '#222', border: 'none', borderRadius: 8,
//                   padding: '12px 0', fontWeight: 600, fontSize: 16, cursor: 'pointer', width: '100%',
//                   marginBottom: 0, height: 48,
//                   boxShadow: socialType === 'kakao' ? '0 0 0 2px #FEE500' : 'none'
//                 }}
//               >
//                 <img src="https://img.icons8.com/ios-filled/24/000000/speech-bubble--v1.png" alt="카카오 말풍선" style={{ width: 24, height: 24 }} />
//                 카카오 본인 인증
//               </button>
//             </div>
//           </div>
...
//       ) : (
//         <div>
//           <div style={{ marginBottom: 24, padding: 12, background: '#e8f5e8', borderRadius: 8, border: '1px solid #4caf50' }}>
//             <span style={{ color: '#2e7d32', fontWeight: 600 }}>✓ 본인 인증이 완료되었습니다.</span>
//           </div>
          
//           <h3 style={{ marginBottom: 16 }}>탈퇴 진행</h3>
//           <p style={{ marginBottom: 24, color: '#666' }}>
//             본인 인증이 완료되었습니다. 아래 버튼을 클릭하면 회원 탈퇴가 진행됩니다.
//           </p>
